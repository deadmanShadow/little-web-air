    ...
    <header className="sticky top-0 z-50 w-full border-b bg-white/80 backdrop-blur-md">
      <div className="container mx-auto flex h-20 items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <Link href="#resources" className="text-sm font-medium text-gray-600 hover:text-primary transition-colors">Resources</Link>
        </nav>
      ...
      {isOpen && (
        <div className="md:hidden border-t bg-white p-4 space-y-4 absolute top-20 left-0 w-full shadow-lg animate-in slide-in-from-top duration-300">
          <nav className="flex flex-col space-y-4">
            ...
            <Link href="#about" className="text-sm font-medium text-gray-600 hover:text-primary" onClick={() => setIsOpen(false)}>About</Link>
            ...
            <Link href="#blog" className="text-sm font-medium text-gray-600 hover:text-primary" onClick={() => setIsOpen(false)}>Blog</Link>
            <Link href="#resources" className="text-sm font-medium text-gray-600 hover:text-primary" onClick={() => setIsOpen(false)}>Resources</Link>
          </nav>
